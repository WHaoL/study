...
namespace sylar
{
    ...
    protected:
        LogLevel::Level m_level;       //本LogAppender对象 对哪些日志定义的级别
    ...
    public:
        ...
        const string &getLoggerName() const { return m_name; }
    ...
    public:
        ...
        FileLogAppender(const std::string &filename); //设置文件名
        virtual void log(LogLevel::Level level, LogEvent::ptr event) override;
        //重新打开文件，文件打开成功返回true
        bool reopen();
    ...
    private:
        ...
        std::ofstream m_filestream; //文件流对象
    };
